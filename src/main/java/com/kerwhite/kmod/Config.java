...
public class Config
{
    ...
    private static final ForgeConfigSpec.BooleanValue ENABLEPARTICLES = BUILDER.comment("Enable kmod's block's particles").define("enableParticles",true);
...
//
    ...
    {
        enableparticles = ENABLEPARTICLES.get();
